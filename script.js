$(document).ready(function () {
  ...
  function updateNav() {
    ...
    // loop through this and create li elements
  ...
  function handleCitySearch(searchInput) {
    $("#current-city")
      .append(searchInput)
      .append(" " + currentDate);
  ...
  function handle5Daylookup(searchInput) {
    var fiveDayUrl =
  ...
  $("#search-button").on("click", handleClickEvent);
  $(document).on("click", ".prev_city", handlePrevClick);
  updateNav();
});